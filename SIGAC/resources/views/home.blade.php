...
<div class="container" >
    ...
    <div class="welcome-container" style="max-width: 700px;">
            ...
            <div class="card-body p-4">
                <div class="text-center">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <a href='alunos' class="btn btn-purple-light px-4">
                            <i class="bi bi-people me-1"></i> Alunos
                        </a>
                        <a href="cursos" class="btn btn-outline-purple-light px-4">
...
<style>
    ...
    .bg-purple-light { background-color: #9c88ff; }
    .text-purple-light { color: #9c88ff; }
